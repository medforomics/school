...
if [[ -z $index_path ]]; then
    index_path="/project/shared/bicf_workflow_ref/human/grch38_cloud/giab_ref"
fi
if [[ -z $index_path ]]; then
    tpanel="/project/shared/bicf_workflow_ref/human/panels/UTSW_V3_pancancer/targetpanel.bed"
fi
