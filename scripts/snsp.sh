...
module load bedtools/2.26.0 samtools/1.4.1
perl /project/PHG/PHG_Clinical/clinseq_workflows/filter_giab.pl $ID
...
bcftools reheader -h hdr.txt -o ${ID}.utswcoding.vcf.gz ${ID}.t.vcf.gz
...
perl /project/PHG/PHG_Clinical/clinseq_workflows/calc_snsp.pl  ${ID}.eval.vcf
